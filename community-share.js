...
class CommunityShareManager {
    ...
    async loadCommunityQuizzes() {
        try {
            ...
            // Không log lỗi CORS vì đây là lỗi bình thường khi chạy local
            if (!error.message.includes('Failed to fetch')) {
                console.warn('⚠️ Community quizzes unavailable:', error.message);
            }
            ...
            if (oldCache) {
                try {
                    ...
                    console.log('📦 Using cached data:', this.communityQuizzes.length, 'quizzes');
                } catch (e) {
                    this.communityQuizzes = [];
                }
            }
